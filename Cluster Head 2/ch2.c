...
void flash_SetSectorAddrs(uint8_t sector, uint32_t addrs)
{
	...
	flash_EraseSector();			//Erase sector before write
}
...
int node2_addr=0xA2;
int node3_addr=0xA3;
uint8_t packet_send[14];
uint8_t packet_send2[26] = {1U,2U,3U,4U,5U,6U,7U,8U,9U,10U,11U,12U,13U,14U,15U,16U,17U,18U,19U,20U,21U,22U,23U,24U,25U,26U};
int data1;
int offset=0;
uint8_t a[14];
int id_verify=0;
...
void  config_rtc (void){
	...
	aRTC_handle.AlarmTime.Minutes = 03U;
